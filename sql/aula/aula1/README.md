...
Bem-vindo à primeira aula do curso de SQL! Esta aula apresenta os conceitos fundamentais de SQL e bancos de dados relacionais.
...
- O que é SQL e sua história
- Componentes do SQL (DDL, DML, DCL, Queries)
...
- Exercícios de escrita de queries
...
- [ ] Explicar o que é SQL e seus componentes principais
- [ ] Entender o conceito de bancos de dados relacionais
- [ ] Diferenciar DDL, DML e DCL
- [ ] Compreender os benefícios e limitações de RDBMS
- [ ] Entender a diferença entre SQL e NoSQL
- [ ] Aplicar boas práticas básicas ao escrever queries
- [ ] Pensar criticamente sobre performance e otimização

## 📖 Pré-requisitos

- Banco de dados `biblioteca.db` criado e funcionando
- Acesso ao SQLite (via CLI ou ferramenta visual)
- Conhecimento básico de conceitos de programação (opcional, mas útil)
...
- **Não tenha pressa**: Leia com calma e entenda os conceitos
- **Pratique**: Execute as queries no banco de dados real
- **Pense criticamente**: As perguntas de reflexão são tão importantes quanto os exercícios práticos
